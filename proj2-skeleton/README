...
We will grade your project submissios on CS Linux Machine (mc01.cs.purdue.edu-mc18.cs.purdue.edu). Make sure your code works on these machines! It is recommended to develop on ecelinux or your own computer running a popular flavour of Linux. There were reports show that ``sort'', as an example, behaves differently in Mac than in Linux. Cygwin and MinGW were not tested.
