...
print("Y_train_total: " + str(len(Y_train)))
for s in Y_train:
    if s == one:
        count += 1
print("Y_train_buggy: " + str(count))

count = 0
print("Y_test_total: " + str(len(Y_test)))
for s in Y_test:
    if s == one:
        count += 1
print("Y_test_buggy: " + str(count))

count = 0
print("Y_valid_total: " + str(len(Y_valid)))
for s in Y_valid:
    if s == one:
        count += 1
print("Y_valid_buggy: " + str(count))
